...
<body>
    ...
    <main>
        <table width="100%" cellpadding="7" cellspacing="0">
            <tbody>
                <tr>
                    ...
                    <td width="60%" style="border: none;line-height: 150%;padding-left: 120px;padding-right: 120px" align="center">
                ...
                <tr>
                    <td colspan="3">
                        <p>
                            <span class="contract_label_bold">AGREEMENT NO : IKSB/CRWD </span>
                        </p>
                    </td>
                </tr>
                <tr>
        ...
        <table width="100%" cellpadding="7" cellspacing="0">
            <tr>
                <td class="td_normal td_last_cell_in_row" colspan="2">
                    <p>
                        <span class="contract_label">Name : </span><span class="contract_value">INAI KIARA SDN BHD</span>
                    </p>
                </td>
            </tr>
            <tr>
                <td class="td_normal td_last_cell_in_row" colspan="2">
                    <p>
                        <span class="contract_label">Address : </span><span class="contract_value">LEVEL 3,BANGUNAN PALM GROVE NO.14,JLN GLENMARIE PERSIARAN KERJAYA,SECTION U1,40150 SHAH ALAM SELANGOR</span>
                    </p>
                </td>
            </tr>
            <tr>
                ...
                <td width="80%" class="td_normal td_last_cell_in_row td_last_cell_in_col">
                    <p>
                        <span class="contract_value">603-55698856</span>
                    </p>
                </td>
            </tr>
        </table>
                ...
                <td colspan="3" class="td_normal td_last_cell_in_row td_last_cell_in_col" style="padding: 0in 0.08in -0.03in">
                    <ol>
                        ...
                        <p class="contract_terms">
                            The applicable IKSB T&amp;C shall be considered to be incorporated into and to form part of the contract. Refer to Appendix 1 IKSB T&amp;C : Inai Kiara Sdn Bhd Terms &amp; Conditions / Handbook for Seafarers.
                        </p>
                        <li/>
                        <p class="contract_terms">
                            The
                            Ship’s Articles shall be deemed for all purposes to include
                            the terms of this Contract (including the applicable IKSB T&amp;C)
        ...
        <table width="100%" cellpadding="7" cellspacing="0" style="padding-top: 25px;">
            <tbody>
            <tr>
                ...
                <td width="33%" class="td_normal td_last_cell_in_col" valign="top">
                    ...
                    @if(!$seafarerContract->is_dummy)
                        <p style="margin-left: 50px; margin-top: -15px">
                            <span><img src="{{asset('print/signature.jpg')}}" alt="" width="100px"></span>
                        </p>
