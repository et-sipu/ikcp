    ...
    <div class="starter-template">
        <div class="row">
            <div class="col-xs-9 text-left">
                <p class="mb-1" style="font-family: Arial black; font-size: 22pt;font-weight: bolder">FLIGHT RESERVATION FORM HQ
                        ...
                        <div class="panel-body p-0">
                            <div class="row mx-0 border rounded-top">
                                ...
                                <div class="col-xs-8 text-left">
                                    <p class="mb-0 heading">{{ucwords($flight_reservation->requester->name)}}</p>
                                </div>
                            </div>
                            ...
                            <div class="row mx-0 border rounded-bottom">
                                ...
                                <div class="col-xs-8 text-left d-flex" style="align-items: center; flex-wrap: wrap">
                                    <p class="mb-0">{{ucwords($flight_reservation->requester->department->name)}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xs-5 text-left">
                <div class="row panel panel-warning">
                    <div class="col-xs-12 border">
                        <p style="font-family:Myriad Pro; font-size: 11pt; font-weight: bolder" class="mb-0 pl-2 pr-2 pb-3 pt-1">VESSEL: &nbsp;{{$flight_reservation->vessel->name}}</p>
                    </div>
                </div>
                <div class="row panel">
        ...
        <div class="row">
            ...
            <div class="col-xs-4">
                <div class="panel panel-warning">
                    ...
                    <div class="panel-body signature border py-0 extra-border">
                        <span style="font-family:Arial; font-style: italic; font-size: 7pt;font-weight: 600" class="mb-1 pt-0">IMMEDIATE SUPERIOUR</span><br>
            ...
            <div class="col-xs-8">
                <div class="panel panel-warning" style="border-left: 1px solid #ddb21e">
                    <div class="panel-heading border"><p class="mb-0 heading">APPROVED BY: EITHER OF THE FOLLOWING GROUP</p></div>

                    <div class="panel-body signature border py-0">
                        <div class="row">
                            <div class="col-xs-6 extra-border">
                                <span style="font-family:Arial; font-style: italic; font-size: 7pt;font-weight: 600" class="mb-1 pt-0">HOD CORPORATE SERVICES</span><br>
                                GENERATED AUTOMATICALLY<br><br>
                                @php
                                    $name = '';
                                    $date = '';
                            ...
                            <div class="col-xs-6 extra-border">
                                <span style="font-family:Arial; font-style: italic; font-size: 7pt;font-weight: 600" class="mb-1 pt-0">GGROUP 2 (SGM / GM)</span><br>
                                GENERATED AUTOMATICALLY<br><br>
                                @php
                                    $name = '';
                                    $date = '';
