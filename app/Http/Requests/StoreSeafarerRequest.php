...
class StoreSeafarerRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            //'documents_info.medical_cert.no' => 'nullable|between:6,30',
            'documents_info.medical_cert.expiry' => 'nullable|required_unless:documents_info.medical_cert.no,|date_format:Y-m-d',

            //'documents_info.coc_cert.no' => 'nullable|between:6,30',
            'documents_info.coc_cert.expiry' => 'nullable|required_unless:documents_info.coc_cert.no,|date_format:Y-m-d',

            //'documents_info.smc.no' => 'nullable|between:6,30',
            'documents_info.smc.expiry' => 'nullable|required_unless:documents_info.smc.no,|date_format:Y-m-d',

            //'documents_info.discharge_book.no' => 'nullable|between:6,30',
            'documents_info.discharge_book.expiry' => 'nullable|required_unless:documents_info.discharge_book.no,|date_format:Y-m-d',
        ];
    }
}
