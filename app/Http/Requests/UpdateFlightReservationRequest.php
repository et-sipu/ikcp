...
class UpdateFlightReservationRequest extends FormRequest
{
    /**
    ...
    {
        if ('purchasing' === $this->get('status')) {
            return [
                'price'             => 'required|numeric',
            ];
        }

        if ('deducting' === $this->get('status')) {
            return [
...
//            'trips.*.trip_attributes.return_to' => 'required_if:trips.*.trip_attributes.flight_type,RETURN',
            ...
            'purpose'             => 'required',
            'deduction'             => 'required|numeric',
            'passengers.*.file'   => 'required_if:passengers.*.url,|nullable|mimes:jpeg,jpg,png,gif,pdf',
...
//            'passengers.*.expiry'   => 'required|date_format:Y-m-d',
//            'passengers.*.hp'   => 'required',
//            'passengers.*.passport'   => 'required',
